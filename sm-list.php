...
<h2>For Revision Verification</h2>
<hr>
        ...
        <table class="display table table-striped table-hover table-bordered" id="" cellspacing="0">
            ...
            <tbody>
                ...
                if(isset($_GET['category_id2'])  && $_GET['category_id2'] != 'all'){
                    if ($usertype == 'Agent')
                        $where .= " where coo_approval = '".$_GET['category_id2']."' and c_created_by = '$username'  and c_revised = 1";
                    
                    if ($usertype == 'COO')
                        $where .= " where coo_approval = '".$_GET['category_id2']."'  and c_verify = '1' and c_revised = 1 ";
                    else
                        $where .= " where coo_approval = '".$_GET['category_id2']."' and c_revised = 1";
                }
                else{
                    if ($usertype == 'Agent')
