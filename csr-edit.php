...
?>
<body onload='hideTxtBox()'>
		<h2>Update CSR #<?php echo $getID; ?> </h2>
		<!-- <hr> -->
		...
		<form method="post" id="update_csr">
			...
			<div id="invoice_totals" class="padding-right row text-right">
				<div class="col-xs-6">
					...
					<div><input type="text" class="form-control margin-bottom"  name="" id="p1" placeholder="%" value="<?php echo $payment1; ?>" tabindex = '36'></div>
...
<script>
	function hideTxtBox(){
		...
		if (p1=='Full DownPayment'){
			document.getElementById("customer_first_name_2").style.display = 'none';
		}
	}
</script>