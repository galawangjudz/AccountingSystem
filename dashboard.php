        ...
        <div class="row">
          <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box">
              ...
              <div class="icon">
              <a href="index.php?page=sm-list&category_id=1"><i class="fa-sharp fa-solid fa-check-to-slot"></i></a>
              </div>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box">
              ...
              <div class="icon">
              <a href="index.php?page=sm-list&category_id=0"><i class="fa-sharp fa-solid fa-clock"></i></a>
              </div>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box">
              ...
              <div class="icon">
              <a href="index.php?page=sm-list&category_id=3"><i class="fa-solid fa-circle-xmark"></i></a>
              </div>
            </div>
          </div>
          <!-- ./col -->
