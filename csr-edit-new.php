                                            ...
                                            <div class="row">
                                                <div class="col-xs-3">		
                                                    ...
                                                    <label class="control-label">Last Name: </label>
                                                        <input type="text" class="form-control margin-bottom required" name="last_name[]" value="<?php echo $customer_last_name_1 ?>" >
                                                    </div>
                                                ...
                                                <div class="col-xs-3">		
                                                    ...
                                                    <label class="control-label">Suffix Name: </label>
                                                        <input type="text" class="form-control margin-bottom" name="suffix_name[]" value="<?php echo $customer_suffix_name_1 ?>">
                                                    </div>
                                                ...
                                                <div class="col-xs-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control margin-bottom required" name="first_name[]" value="<?php echo $customer_first_name_1 ?>" >
                                                    </div>
                                                ...
                                                <div class="col-xs-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control margin-bottom" name="middle_name[]" value="<?php echo $customer_middle_name_1 ?>">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control margin-bottom required" name="citizenship[]" value="<?php echo $citizenship ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xs-2">
                                                ...
                                                <div class="col-xs-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date margin-bottom" id="birth_date">
                                                            <input type="text" class="form-control required" name="birth_day[]" value="<?php echo $birth_date ?>" placeholder="YYYY-MM-DD" data-date-format="<?php echo DATE_FORMAT ?>" >		
                                                ...
                                                <div class="col-xs-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control margin-bottom required" name="age[]" value="<?php echo $customer_age ?>">
                                                    </div>
                                                </div>	
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control margin-bottom required" name="contact_no[]" value="<?php echo $contact_no ?>">
                                                    </div>	
                                                </div>
                                                <div class="col-xs-2">
                                                    <div class="form-group">
                                                        <label class="control-label">Viber Account: </label>
                                                        <input type="text" class="form-control margin-bottom" name="viber[]" value="<?php echo $customer_viber ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xs-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group float-right margin-bottom">
                                                            ...
                                                            <input type="text" class="form-control margin-bottom required" name="email[]" value="<?php echo $customer_email ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control margin-bottom required" name="address[]" value="<?php echo $customer_address_1 ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xs-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Area Code : </label>
                                                        <input type="text" class="form-control margin-bottom required" name="zip_code[]" value="<?php echo $customer_zip_code ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xs-9">
                                                    <div class="form-group">
                                                        <label class="control-label">Address Abroad (if any): </label>
                                                        <input type="text" class="form-control margin-bottom" name="address_abroad[]" value="<?php echo $customer_address_abroad ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xs-3">
                                                    <div class="form-group">
