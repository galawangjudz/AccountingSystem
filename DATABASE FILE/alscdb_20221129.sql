...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2022 at 06:08 AM
...
CREATE TABLE `t_approval_csr` (
  ...
  `c_csr_status` text DEFAULT NULL,
  `c_reservation_status` text DEFAULT NULL,
  `c_ca_status` text DEFAULT NULL,
  `c_final_status` text DEFAULT NULL,
  `c_approved_by` text NOT NULL,
...
INSERT INTO `t_approval_csr` (`ra_id`, `c_csr_no`, `c_lot_lid`, `c_csr_status`, `c_reservation_status`, `c_ca_status`, `c_final_status`, `c_approved_by`, `c_date_approved`) VALUES
(13, 19, 11000102, 'Approved', NULL, NULL, NULL, '', '2022-11-29 08:19:40'),
(14, 19, 11000102, 'Approved', NULL, NULL, NULL, '', '2022-11-29 08:21:27'),
(15, 20, 14100101, 'Approved', NULL, NULL, NULL, '', '2022-11-29 08:34:39'),
(16, 20, 14100101, 'Approved', NULL, NULL, NULL, '', '2022-11-29 11:37:38'),
(17, 20, 14100101, 'Approved', NULL, NULL, NULL, '', '2022-11-29 11:45:27');
...
CREATE TABLE `t_csr` (
  ...
  `c_duration` datetime DEFAULT NULL,
...
INSERT INTO `t_csr` (`c_csr_no`, `c_lot_lid`, `c_date_of_sale`, `c_b1_last_name`, `c_b1_first_name`, `c_b1_middle_name`, `c_b2_last_name`, `c_b2_first_name`, `c_b2_middle_name`, `c_address`, `c_city_prov`, `c_zip_code`, `c_address_abroad`, `c_billing_address`, `c_birthday`, `c_age`, `c_sex`, `c_mobile_no`, `c_mobile_abroad`, `c_viber_no`, `c_civil_status`, `c_email`, `c_employment_status`, `c_lot_area`, `c_price_sqm`, `c_lot_discount`, `c_lot_discount_amt`, `c_house_model`, `c_floor_area`, `c_house_price_sqm`, `c_house_discount`, `c_house_discount_amt`, `c_tcp_discount`, `c_tcp_discount_amt`, `c_tcp`, `c_vat_amount`, `c_net_tcp`, `c_reservation`, `c_payment_type1`, `c_payment_type2`, `c_down_percent`, `c_net_dp`, `c_no_payments`, `c_monthly_down`, `c_first_dp`, `c_full_down`, `c_amt_financed`, `c_terms`, `c_interest_rate`, `c_fixed_factor`, `c_monthly_payment`, `c_start_date`, `c_csr_status`, `c_reserve_status`, `c_ca_status`, `c_remarks`, `c_date_created`, `c_date_updated`, `c_duration`, `c_created_by`) VALUES
(20, 14100101, '2022-11-29', 'DELA CRUZ', 'JUDE', 'PANGILINAN', '', '', '', '0682 SANTOL', 'BALAGTAS, BULACAN', '3016', '', '', '1994-12-25', 27, 'M', '09561305511', '', '', 'Single', 'jaevoli@gmail.com', 'Employed', 150, 7000, 0, 0, 'Dahlia', 0, 0, 0, 0, 0, 0, 1050000, 0, 1050000, 0, 'Spot Cash', 'Monthly Amortization', 0, 0, 0, 0, 2022, 2022, 1050000, 0, 0, 0, 0, '2023-01-29', '.Approved.', '', '', '', '2022-11-29', '2022-11-29', '2022-11-30 11:45:27', 'judedel');
...
(141, 23, 32, 14102332, '32', 23, 'fe', 'Available', NULL, NULL, NULL, NULL, NULL),
(141, 1, 1, 14100101, '150', 7000, '', 'Available', NULL, NULL, NULL, NULL, NULL),
(110, 1, 3, 11000103, '120', 100000, 'Regular', 'Available', NULL, NULL, NULL, NULL, NULL),
(110, 1, 2, 11000102, '120', 9000, 'Corner Lot', 'Available', NULL, NULL, NULL, NULL, NULL);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `t_csr_view`  AS SELECT `x`.`c_csr_no` AS `c_csr_no`, `x`.`c_lot_lid` AS `c_lot_lid`, `x`.`c_date_of_sale` AS `c_date_of_sale`, `x`.`c_b1_last_name` AS `c_b1_last_name`, `x`.`c_b1_first_name` AS `c_b1_first_name`, `x`.`c_b1_middle_name` AS `c_b1_middle_name`, `x`.`c_b2_last_name` AS `c_b2_last_name`, `x`.`c_b2_first_name` AS `c_b2_first_name`, `x`.`c_b2_middle_name` AS `c_b2_middle_name`, `x`.`c_address` AS `c_address`, `x`.`c_city_prov` AS `c_city_prov`, `x`.`c_zip_code` AS `c_zip_code`, `x`.`c_address_abroad` AS `c_address_abroad`, `x`.`c_billing_address` AS `c_billing_address`, `x`.`c_birthday` AS `c_birthday`, `x`.`c_age` AS `c_age`, `x`.`c_sex` AS `c_sex`, `x`.`c_mobile_no` AS `c_mobile_no`, `x`.`c_mobile_abroad` AS `c_mobile_abroad`, `x`.`c_viber_no` AS `c_viber_no`, `x`.`c_civil_status` AS `c_civil_status`, `x`.`c_email` AS `c_email`, `x`.`c_employment_status` AS `c_employment_status`, `x`.`c_lot_area` AS `c_lot_area`, `x`.`c_price_sqm` AS `c_price_sqm`, `x`.`c_lot_discount` AS `c_lot_discount`, `x`.`c_lot_discount_amt` AS `c_lot_discount_amt`, `x`.`c_house_model` AS `c_house_model`, `x`.`c_floor_area` AS `c_floor_area`, `x`.`c_house_price_sqm` AS `c_house_price_sqm`, `x`.`c_house_discount` AS `c_house_discount`, `x`.`c_house_discount_amt` AS `c_house_discount_amt`, `x`.`c_tcp_discount` AS `c_tcp_discount`, `x`.`c_tcp_discount_amt` AS `c_tcp_discount_amt`, `x`.`c_tcp` AS `c_tcp`, `x`.`c_vat_amount` AS `c_vat_amount`, `x`.`c_net_tcp` AS `c_net_tcp`, `x`.`c_reservation` AS `c_reservation`, `x`.`c_payment_type1` AS `c_payment_type1`, `x`.`c_payment_type2` AS `c_payment_type2`, `x`.`c_down_percent` AS `c_down_percent`, `x`.`c_net_dp` AS `c_net_dp`, `x`.`c_no_payments` AS `c_no_payments`, `x`.`c_monthly_down` AS `c_monthly_down`, `x`.`c_first_dp` AS `c_first_dp`, `x`.`c_full_down` AS `c_full_down`, `x`.`c_amt_financed` AS `c_amt_financed`, `x`.`c_terms` AS `c_terms`, `x`.`c_interest_rate` AS `c_interest_rate`, `x`.`c_fixed_factor` AS `c_fixed_factor`, `x`.`c_monthly_payment` AS `c_monthly_payment`, `x`.`c_start_date` AS `c_start_date`, `x`.`c_csr_status` AS `c_csr_status`, `x`.`c_reserve_status` AS `c_reserve_status`, `x`.`c_ca_status` AS `c_ca_status`, `x`.`c_remarks` AS `c_remarks`, `x`.`c_date_created` AS `c_date_created`, `x`.`c_date_updated` AS `c_date_updated`, `x`.`c_created_by` AS `c_created_by`, `z`.`c_acronym` AS `c_acronym`, `y`.`c_block` AS `c_block`, `y`.`c_lot` AS `c_lot` FROM ((`t_csr` `x` left join `t_lots` `y` on(`x`.`c_lot_lid` = `y`.`c_lid`)) left join `t_projects` `z` on(`y`.`c_site` = `z`.`c_code`)) ORDER BY `x`.`c_date_of_sale` ASC  ;
...
--
ALTER TABLE `t_approval_csr`
  MODIFY `ra_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `t_csr`
--
ALTER TABLE `t_csr`
  MODIFY `c_csr_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
